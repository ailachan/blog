...
<head>
    ...
    <script src="../style/js/blogger/jquery.min.js"></script>
    <script src="../style/js/blogger/bootstrap.min.js"></script>
    <script>
        $(function () {
    ...
    <script src="../style/js/blogger/respond.min.js"></script>
    <link href="../style/css/blogger/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="../style/css/blogger/common.css"/>
    <link rel="stylesheet" type="text/css" href="../style/css/blogger/slide.css"/>
    <link rel="stylesheet" type="text/css" href="../style/css/blogger/bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="../style/css/blogger/flat-ui.min.css"/>
    <link rel="stylesheet" type="text/css" href="../style/css/blogger/jquery.nouislider.css">
</head>
...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        ...
        <div id="logoDiv">
            <p id="logoP"><img id="logo" alt="个人博客后台管理系统" src="../style/assets/img/69845363_p0.jpg"></p>
        </div>

        <div id="personInfor">
            <p id="blogger">admin</p>
            <p><span>32830121@qq.com</span></p>
            <p>
        ...
        <div class="meun-item meun-item-active" href="#blog" aria-controls="sour" role="tab" data-toggle="tab">
            <img src="../style/img/blogger/icon_source.png">博文管理
        </div>

        <%-- 博文类别管理 --%>
        <div class="meun-item" href="#blogType" aria-controls="user" role="tab" data-toggle="tab">
            <img src="../style/img/blogger/icon_user_grey.png">博文类别
        </div>
        ...
        <div class="meun-item" href="#comment" aria-controls="user" role="tab" data-toggle="tab">
            <img src="../style/img/blogger/icon_change_grey.png">浏览者评论
        </div>
        ...
        <div class="meun-item" href="#link" aria-controls="user" role="tab" data-toggle="tab">
            <img src="../style/img/blogger/icon_link_grey.png">友情链接
        </div>
        ...
        <div class="meun-item" href="#info" aria-controls="user" role="tab" data-toggle="tab">
            <img src="../style/img/blogger/icon_chara_grey.png">个人信息
        </div>
...
<script src="../style/js/blogger/jquery.nouislider.js"></script>
